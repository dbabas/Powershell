...
Get-NAVServerInstance | Get-NAVServerConfiguration2 | where key -eq "DatabaseName" |  where {$_.Value -eq 'LIVE'} | Format-Table -AutoSize
Get-NAVServerInstance | Get-NAVServerConfiguration2 | where key -eq "ClientServicesPort" | Format-Table -AutoSize